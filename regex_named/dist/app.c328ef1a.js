...
var REG_EMAIL = _wrapRegExp(/([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})/gi, {
  user: 1,
  domain: 2,
  tld: 3
});

var txt = "ghoul.ahmed5@gmail.com"; // Extract entities

var entities = REG_EMAIL.exec(txt);

if (entities) {
  var _entities$groups = entities.groups,
      user = _entities$groups.user,
      domain = _entities$groups.domain,
      tld = _entities$groups.tld;
